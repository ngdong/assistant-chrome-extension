...
const BookmarkItem = (bookmark, index) => {
  ...
  return `
    <div draggable="true" class="item" data-type="${bookmark.type}"
      ...
      <div class="delete">
        <a class="item-title btn-delete-bookmark" data-id="${bookmark.id}">
          <img src="icons/delete.svg" alt="Delete" width="18px">
        </a>
      </div>
    </div>
    <div draggable="true" class="item drag-item" data-id="${bookmark.id}"
